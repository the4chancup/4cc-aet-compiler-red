...
# Template files
TEMPLATE_FOLDER_PATH         = "./Engines/templates"
...
# Settings tools
SETTINGS_DEFAULT_PATH        = "./Engines/templates/settings_default.ini"
SETTINGS_TRANSFER_TABLE_PATH = "./Engines/templates/settings_transfer_table.txt"
